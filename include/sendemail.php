...
$toemails[] = array(
	'email' => 'abhijeet.seasons@gmail.com', // Your Email Address
	'name' => 'Abhijeet Bhamare' // Your Name
);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	if( $_POST['cf-email'] != '' ) {
		...
		if( $botcheck == '' ) {
			...
			$referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This mail was sent from: ' . $_SERVER['HTTP_REFERER'] : '';
